...
class FormGameLevel2(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        dict_level_2 = level_2(self)
        self.plataform_list = dict_level_2['plataforma']
        self.enemy_list = dict_level_2['enemigos']
        self.list_trap = dict_level_2['trampas']
        self.coin_list = dict_level_2['estrellas']
        self.list_lifes = dict_level_2['vidas']
        self.player_1 = dict_level_2['player']
