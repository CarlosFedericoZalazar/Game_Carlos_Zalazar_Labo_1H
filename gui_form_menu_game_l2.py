...
class FormGameLevel2(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton_shoot = Button(master=self,x=400,y=0,w=140,h=50,color_background=None,color_border=None,image_background="images\gui\Gui\Buttom.png",on_click=self.on_click_shoot,on_click_param="form_menu_B",text="BALA",font="Verdana",font_size=30,font_color=C_WHITE)
        self.restart = True
        ...
        # LIFES
        self.list_lifes = []
        self.list_lifes.append(Life(x=200,y=550))
        self.list_lifes.append(Life(x=1250,y=200))
        ...
        # self.enemy_list.append (Enemy(master=self,x=800,y=300,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.08,interval_time_jump=300, shoot=True))
        # self.enemy_list.append (Enemy(master=self,x=859,y=200,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.08,interval_time_jump=300, shoot=True, steps=30))
