...
class FormMenuA(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background, color_border,active):
        ...
        self.boton3 = Button(master=self,x=450,y=450,w=160,h=100,color_background=None,color_border=None,image_background="images\gui\Gui\Buttom_play.png",on_click=self.on_click_boton3,on_click_param="form_game_L3",text="",font="Verdana",font_size=30,font_color=C_WHITE)
