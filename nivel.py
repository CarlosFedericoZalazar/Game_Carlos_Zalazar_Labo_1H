...
def level_2(self):
    ...
    ## PLATAFORMAS ##
    for aux in range(0,1400,50):
            list_plataforma.append(Plataform(x=aux,y=650,width=50,height=50,type=1, style_tile='forest'))
    
    list_plataforma.append(Plataform(x=0,y=500,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=50,y=500,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=100,y=500,width=50,height=50,type=14, style_tile='forest'))

    # PLATAFORMA 2
    list_plataforma.append(Plataform(x=400,y=500,width=50,height=50,type=12, motion=True, speed_move_x = 1, speed_move_y = 0, move_rate_ms=100, style_tile='forest'))
    list_plataforma.append(Plataform(x=450,y=500,width=50,height=50,type=13, motion=True, speed_move_x = 1, speed_move_y = 0, move_rate_ms=100, style_tile='forest'))
    list_plataforma.append(Plataform(x=500,y=500,width=50,height=50,type=14, motion=True, speed_move_x = 1, speed_move_y = 0, move_rate_ms=100, style_tile='forest'))
    
    list_plataforma.append(Plataform(x=700,y=650,width=50,height=50,type=12, style_tile='forest'))
    list_plataforma.append(Plataform(x=750,y=700,width=50,height=50,type=14, style_tile='forest'))
        
        # PLATAFORMA 3
    list_plataforma.append(Plataform(x=700,y=500,width=50,height=50,type=12, style_tile='forest'))
    list_plataforma.append(Plataform(x=750,y=500,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=800,y=500,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=850,y=500,width=50,height=50,type=14, style_tile='forest'))

    list_plataforma.append(Plataform(x=1050,y=400,width=50,height=50,type=12, motion=True, speed_move_x = 1, speed_move_y = 0, move_rate_ms=100, style_tile='forest'))
    list_plataforma.append(Plataform(x=1100,y=400,width=50,height=50,type=14, motion=True, speed_move_x = 1, speed_move_y = 0, move_rate_ms=100, style_tile='forest')) 
    # PLATAFORMA 4
    list_plataforma.append(Plataform(x=550,y=550,width=50,height=50,type=12, style_tile='forest'))
    list_plataforma.append(Plataform(x=600,y=550,width=50,height=50,type=14, style_tile='forest'))
    # PLATAFORMA 5
    list_plataforma.append(Plataform(x=1350,y=500,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=1300,y=500,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=1250,y=500,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=1200,y=500,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=1150,y=500,width=50,height=50,type=12, style_tile='forest'))
     # PLATAFORMA 6
    list_plataforma.append(Plataform(x=0,y=350,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=50,y=350,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=100,y=350,width=50,height=50,type=14, style_tile='forest'))
     # PLATAFORMA 7
    list_plataforma.append(Plataform(x=250,y=350,width=50,height=50,type=12, style_tile='forest'))
    list_plataforma.append(Plataform(x=300,y=350,width=50,height=50,type=14, style_tile='forest'))
     # PLATAFORMA 8
    list_plataforma.append(Plataform(x=400,y=400,width=50,height=50,type=12, style_tile='forest'))
    list_plataforma.append(Plataform(x=450,y=400,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=500,y=400,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=550,y=400,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=600,y=400,width=50,height=50,type=14, style_tile='forest'))
    # PLATAFORMA 9
    list_plataforma.append(Plataform(x=750,y=250,width=50,height=50,type=12, style_tile='forest'))
    list_plataforma.append(Plataform(x=800,y=250,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=850,y=250,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=900,y=250,width=50,height=50,type=14, style_tile='forest'))
    # PLATAFORMA 10
    list_plataforma.append(Plataform(x=1350,y=350,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=1300,y=350,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=1250,y=350,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=1200,y=350,width=50,height=50,type=12, style_tile='forest'))
    # PLATAFORMA 11
    list_plataforma.append(Plataform(x=400,y=250,width=50,height=50,type=12, style_tile='forest'))
    list_plataforma.append(Plataform(x=450,y=250,width=50,height=50,type=13, style_tile='forest'))
    list_plataforma.append(Plataform(x=500,y=250,width=50,height=50,type=14, style_tile='forest'))

    ## ENEMIGOS ##
    enemys_list.append (Enemy(master=self,x=50,y=400,speed_walk=3,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=30,jump_height=140,p_scale=0.08,interval_time_jump=300, shoot=False, steps=10))
    enemys_list.append (Enemy(master=self,x=700,y=400,speed_walk=3,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=30,jump_height=140,p_scale=0.08,interval_time_jump=300, shoot=False, steps=20))
    enemys_list.append (Enemy(master=self,x=1250,y=500,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.08,interval_time_jump=300, shoot=True, steps=10))
    enemys_list.append (Enemy(master=self,x=800,y=100,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.08,interval_time_jump=300, shoot=False, steps=10))
    enemys_list.append (Enemy(master=self,x=859,y=200,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.08,interval_time_jump=300, shoot=False, steps=30))
