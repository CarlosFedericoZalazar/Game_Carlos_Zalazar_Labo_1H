...
class FormGameLevel3(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        # --- COINS ---
        self.coin_list = []
        # self.coin_list.append(Coins(master=self, x=700, y=550,value=100,frame_rate_ms=150, p_scale=0.3))
        # self.coin_list.append(Coins(master=self, x=600, y=450,value=100,frame_rate_ms=150, p_scale=0.3))
        ...
        self.enemy_list = []
        self.enemy_list.append (Boss(master=self, x=815,y=320,speed_walk=3,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=30,jump_height=140,p_scale=0.4,interval_time_jump=300))
