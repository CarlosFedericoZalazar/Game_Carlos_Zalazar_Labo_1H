...
class FormGameWin(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.personaje = Player(master=self, x=150,y=40,speed_walk=8,speed_run=12,gravity=14,jump_power=30,frame_rate_ms=80,move_rate_ms=50,jump_height=110,p_scale=0.5,interval_time_jump=300)
    ...
    def update(self, lista_eventos,keys,delta_ms):          
        ...
        #     self.tiempo_transcurrido_animation = 0
        #     if(self.personaje.frame < len(self.personaje.animationanimation) - 1):
        #         self.personaje.frame += 1                 
        #     else: 
        #         self.personaje.frame = 0           
